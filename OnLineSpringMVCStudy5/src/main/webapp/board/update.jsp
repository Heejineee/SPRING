	...
	<div class="container">
		<div class="row">
			...
			<form method=post action="update_ok.do" enctype="multipart/form-data">
				<table class="table">
					<tr>
						<th class="text-righ info" width=15%>이름</th>
						<td>
							<input type=text name=name size=15 value="${vo.name }">
							<input type=hidden name=no value="${vo.name}">
						</td>
					</tr>
					<tr>
						<th class="text-righ info" width=15%>제목</th>
						<td>
							<input type=text name=subject size=50 value="${vo.subject }">
						</td>
					</tr>
					<tr>
						<th class="text-righ info" width=15%>내용</th>
						<td>
							<textarea rows="8" cols="55" name=content>${vo.content }</textarea>
						</td>
					</tr>
					<tr>
						<th class="text-righ info" width=15%>비밀번호</th>
						<td>
					...
					<tr>
						<td colspan=2 class="text-center">
							<input type=submit value="수정하기" class="btn btn-sm btn-warning">
