...
public class ReplyDAO {
	...
	private final String URL="jdbc:oracle:thin:@211.238.142.193:1521:XE";
	public ReplyDAO()
	{
		try
		{
	...
	public void disConnection()
	{
		try
		{
			if(cs!=null) cs.close();	// procedure 호출할 때 사용(댓글 프로시저로 되어있어서 사용)
			if(ps!=null) ps.close();	// 일반 sql 보낼 때 사용
